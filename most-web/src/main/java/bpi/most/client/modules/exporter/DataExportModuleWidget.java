...
import bpi.most.client.modules.exporter.filter.ExportFilterWidget;
import bpi.most.client.utils.ui.DpCollectorWidget;
...
public class DataExportModuleWidget extends ModuleWidget {
    ...
    @UiField
    DpSelectWidget dpselect;

    @UiField(provided = true)
    DpCollectorWidget dpcollect = new DpCollectorWidget(new String[] {
            "dropWidget", "dWidget-uid-export" }, null);

    @UiField
    ExportFilterWidget exportFilter;
    ...
    void handleClick(ClickEvent e) {
        exportFilter.startExecute(dpcollect.getDatapoints(), "csv");
    }
