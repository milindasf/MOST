 ...
 */
public class DatapointFinderHibernate implements IDatapointFinder {

    private static final Logger LOG = LoggerFactory.getLogger(DatapointFinderHibernate.class);

    private final EntityManager em;

    public DatapointFinderHibernate(EntityManager em) {
        this.em = em;
    }
