...
////////////////////////////////////////////////////////////////
    ...
    public int addIntConst(int v) {
        ...
        switch (v) {
            case -1:
                return add(Jvm.ICONST_M1);
            case 0:
                return add(Jvm.ICONST_0);
            case 1:
                return add(Jvm.ICONST_1);
            case 2:
                return add(Jvm.ICONST_2);
            case 3:
                return add(Jvm.ICONST_3);
            case 4:
                return add(Jvm.ICONST_4);
            case 5:
                return add(Jvm.ICONST_5);
        }
